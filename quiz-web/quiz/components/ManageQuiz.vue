<template>
	<div>
		<div class="row">
			<h3 class="grey-text ">Quiz Editor</h3>		
			<div class="col s12">
				<div class="row">
	                ...
	                <div class="col l6 s12 padd" style="overflow:scroll; height : 400px; border : 1px solid #409EFF; border-radius : 5px; width : 400px;">
	                	<div class="right">
					 	 <el-button @click="updateQuiz" v-if = "questions.length != 0" type="primary" class="" icon = "el-icon-plus">Update</el-button>
					 </div>
	                	<el-table
...
export default {
  ...
  mounted(){
    this.questionForm.quiz_name = this.init.name
    this.questions = this.init.questions
  },
  methods : {
